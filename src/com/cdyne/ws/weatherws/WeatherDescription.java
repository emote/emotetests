 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for PictureURL
                        */

                        
                                    protected java.lang.String localPictureURL ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPictureURLTracker = false ;

                           public boolean isPictureURLSpecified(){
                               return localPictureURLTracker;
                           }
                           ...
                           */
                           public  java.lang.String getPictureURL(){
                            ...
                            /**
                               ...
                               */
                               public void setPictureURL(java.lang.String param){
                            localPictureURLTracker = param != null;
                                   
                                            this.localPictureURL=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WeatherDescription",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WeatherDescription",
                           xmlWriter);
                              ...
                              if (localDescriptionTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localPictureURLTracker){
                                    namespace = "http://ws.cdyne.com/WeatherWS/";
                                    writeStartElement(null, namespace, "PictureURL", xmlWriter);
                             

                                          if (localPictureURL==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("PictureURL cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPictureURL);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                             ...
                             if (localDescriptionTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.cdyne.com/WeatherWS/",
                                        ...
                                        if (localPictureURL != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPictureURL));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("PictureURL cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static WeatherDescription parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WeatherDescription".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WeatherDescription)com.cdyne.ws.weatherws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.cdyne.com/WeatherWS/","PictureURL").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"PictureURL" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setPictureURL(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
